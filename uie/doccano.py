...
if __name__ == "__main__":
    ...
    parser.add_argument("--doccano_file", default="./data1/doccano_ext.json", type=str, help="The doccano file exported from doccano platform.")
    parser.add_argument("--save_dir", default="./data1", type=str, help="The path of data that you wanna save.")
